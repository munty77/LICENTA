...
function SetFilter(Produse){
    ...
    Produse.forEach(element => {
        ...
        if(ckStoc.checked && 
            ...
            !ckIncPret.checked && !ckDecPret.checked && !ckReducere.checked){
            
            lstFiltre = lstTotala.slice();
        ...
        if(ckIncPret.checked && ckStoc.checked &&
            !ckPromo.checked && !ckAllDsp.checked &&
            !ckAllCat.checked && !ckBluze.checked && !ckRochii.checked &&
            !ckAllBr.checked && !ckBershka.checked && !ckZara.checked &&
            !ckDecPret.checked && !ckReducere.checked){

            lstFiltre = lstTotala.slice();
            console.log("LISTA(totala) - inc + stoc:", lstFiltre);
            if(element.val().Stoc === 0){
                ...
                console.log("LISTA DUPA STERGERE - inc + stoc: ", lstFiltre);
            }else if(lstFiltre.includes(element.key)){
...
function AddItem(key, brand, imagine1, imagine2, nume, pret, reducere, pretRedus, favoriteBy){
    ...
    btnSave.addEventListener('click', () => {
        ...
        console.log("");
        console.log("CHEIA PRODUSULUI >>> ", key);
        console.log("");
        ...
        update(child(dbRef, "Produse/" + key + "/" + "Detalii"), {
